const Footer = () => (
    <footer className="w-full ">
        <div className="container mx-auto px-4 text-center bg-gray-900 dark:bg-gray-900 py-6">
            <div className="flex flex-col items-center">
                {/* Links Section */}
                <div className="mb-4 space-x-4">
                    <a
                        href="#"
                        className="text-sm text-gray-800 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 transition-colors duration-300"
                    >
                        Privacy Policy
                    </a>
                    <a
